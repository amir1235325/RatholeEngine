...
1. 🚀 **[راهنمای شروع سریع (Getting Started)](Getting-Started.md)**
   - نصب خودکار یک‌خطی
   - گزینه‌های نصب (Panel / Node / Hub)
   - پیش‌نیازها و معماری عمومی

2. ⚡ **[راهنمای Adaptive Filtering (سوئیچ خودکار)](Adaptive-Filtering-Guide.md)**
...
3. 📖 **[مرجع کامل دستورات CLI (CLI Reference)](CLI-Reference.md)**
...
4. 🖥️ **[مدیریت مرکزی با Hub (Hub Management)](Hub-Management.md)**
   - نصب و کانفیگ پنل وب Hub (`hub.py`)
   - راهنمای REST API و امنیت اتصال SSH
   - آپدیت گروهی و مانیتورینگ لایو سرورها

5. 🛠️ **[عیب‌یابی، بک‌آپ و رول‌بک (Troubleshooting)](Troubleshooting.md)**
...
پروژه تحت لایسنس **[MIT](../../LICENSE)** به‌صورت متن‌باز منتشر شده است.
