...
const DICT={
 fa:{
  ...
  ports_sec:'port-ha',
  ports_hint:'se port-e aval ba «ratholectl set» avaz mishavand. baghi moghe-e roshan kardan-e halat-e khodeshan taein mishavand va inja faghat neshan dade mishavand.',
  ports_none:'port-e digari faal nist.',
  p_fake:'sait-e fik',p_sub:'sabaskripshn',p_control:'kontrol-e rathole',
 ...
 en:{
  ...
  ports_sec:'Ports',
  ports_hint:'The first three are changed via "ratholectl set". The rest are chosen when you enable their mode and are shown here for reference.',
  ports_none:'No other ports active.',
  p_fake:'Fake site',p_sub:'Subscription',p_control:'rathole control',
