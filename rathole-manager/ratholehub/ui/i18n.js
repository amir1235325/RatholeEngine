...
const DICT={
 fa:{
  ...
  conn_transport:'masir',conn_dial:'dial endpoint',conn_sni:'TLS/SNI',conn_crypto:'ramznegari',conn_live:'vaziat',yes:'bale',no:'na',
  l_bh_mode:'mode-e dastresi',bh_direct_warn:'Direct-IP Backhaul TLS nadarad. edame midahid?',
  ...
  main_domain_tls:'domain + TLS omomi',main_ip_sni:'IP dial + SNI domain',main_ip_self:'IP + TLS self-signed',main_ip_self_confirm:'gvahi self-signed-e IP rooye Iran sakhte va public cert rooye node trust mishavad. edame?',
 ...
 en:{
  ...
  conn_transport:'transport',conn_dial:'dial endpoint',conn_sni:'TLS/SNI',conn_crypto:'encryption',conn_live:'live state',yes:'yes',no:'no',
  l_bh_mode:'exposure mode',bh_direct_warn:'Direct-IP Backhaul has no TLS. Continue?',
  ...
  main_domain_tls:'Domain + public TLS',main_ip_sni:'IP dial + domain SNI',main_ip_self:'IP + self-signed TLS',main_ip_self_confirm:'Create an IP self-signed certificate on Iran and trust its public certificate on this node. Continue?',
